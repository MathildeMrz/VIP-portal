...
public class ParserIT extends BaseSpringIT {
    ...
    /*@Test
    public void testGetApplicationDescriptor()
    {
        workflowBusiness.getApplicationDescriptor()
    }
    ...
    {
        workflowBusiness.clean();
    }

    @Test
    public void testCompleteClean()
    {
        workflowBusiness.clean();
    }
    ...
    {
        workflowBusiness.purge();
    }

    @Test
    public void testRelaunch()
    {
        workflowBusiness.relaunch();
    }

    @Test
    public void testGetOutputData()
    {
        workflowBusiness.getOutputData()
    }

    @Test
    public void testGetInputData()
    {
        workflowBusiness.getInputData();
    }

    @Test
    public void testDeleteLogData()
    {
        workflowBusiness.deleteLogData();
    }
    ...
    @Test
    public void testGetPerformancesStats()
    {
        workflowBusiness.getPerformanceStats();
    }

    @Test
    public void testValidateInputs()
    {
        workflowBusiness.validateInputs();
    }

    @Test
    public void testUpdateUser()
    {
        workflowBusiness.updateUser();
    }

    @Test
    public void testUpdateDescription()
    {
        workflowBusiness.updateDescription();
    }

    @Test
    public void testGetRunningSimulations()
    {
        workflowBusiness.getRunningSimulations()
    }

    @Test
    public void testMarkCompleted()
    {
        workflowBusiness.markCompleted();
    }

    @Test
    public void testChangeSimulatinUser()
    {
        workflowBusiness.changeSimulationUser();
    }*/
