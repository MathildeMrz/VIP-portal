...
public class CoreSpringServerIT extends BaseSpringIT
{
    ...
    {
        assertFalse(configurationBusiness.getUser(emailUser3).isDeveloper());
    }

    /*@Test
    public void testIsGroupNotAdmin() throws BusinessException
    {
        assertFalse(configurationBusiness.getUser(emailUser3).isGroupAdmin());
    }

    @Test
    public void testIsGroupAdmin() throws BusinessException
    {
        assertTrue(configurationBusiness.getUser(adminEmail).isGroupAdmin());
    }*/
